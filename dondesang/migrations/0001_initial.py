    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel', models.IntegerField(blank=True, max_length=40, null=True)),
                ('email', models.EmailField(blank=True, max_length=80)),
                ('date_created', models.DateTimeField(auto_now=True)),
                ('collects', models.ManyToManyField(blank=True, null=True, to='dondesang.collects')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_partenaire', models.IntegerField(blank=True, max_length=4, null=True)),
                ...
                ('date_de_p', models.DateTimeField(auto_now_add=True, null=True)),
                ...
                ('poid', models.IntegerField(blank=True, max_length=4, null=True)),
                ('taux_hd', models.IntegerField(blank=True, max_length=10, null=True)),
                ('ta', models.IntegerField(blank=True, max_length=10, null=True)),
                ...
                ('date_created', models.DateTimeField(auto_now=True)),
                ('donneur', models.ManyToManyField(blank=True, null=True, to='dondesang.donneur')),
            ],
        ),
        migrations.CreateModel(
            name='Pays',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_ci', models.CharField(blank=True, max_length=30, null=True, unique=True)),
